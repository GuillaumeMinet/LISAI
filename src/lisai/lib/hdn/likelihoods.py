...
class NoiseModelLikelihood(LikelihoodModule):
    ...
    def __init__(self, ch_in, color_channels, 
                 ...
                 data_mean_gt = None,data_std_gt = None):
        super().__init__()
        ...
        if data_mean_gt is not None and data_std_gt is not None:
            self.data_mean_gt = data_mean_gt
            self.data_std_gt = data_std_gt
        else:
            self.data_mean_gt = data_mean
            self.data_std_gt = data_std
    ...
    def log_likelihood(self, x, params):
        ...
        x_denormalized = x * self.data_std_gt + self.data_mean_gt
