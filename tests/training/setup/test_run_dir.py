...
def test_prepare_run_dir_retrain_copies_origin_artifacts_and_saves_clean_config(
    ...
    assert captured["save_yaml"]["cfg"] == {"saved": True}
    assert captured["save_yaml"]["path"] == paths.cfg_train_path(run_dir=new_run_dir)
